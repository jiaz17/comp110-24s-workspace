...
plt.title("Runtime Analysis of Selection Sort - jiaz")
...
plt.title("Runtime Analysis of Insertion Sort - jiaz")
...
plt.title("Memory Usage Analysis of Selection Sort - jiaz")
...
plt.title("Memory Usage Analysis of Insertion Sort - jiaz")
